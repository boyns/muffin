...
public class GIF {
  ...
  public static final byte[] VERSION_87a = {
    (byte) '8',
    (byte) '7',
    (byte) 'a'
  };
  ...
  public static final byte[] VERSION_89a = {
    (byte) '8',
    (byte) '9',
    (byte) 'a'
  };
  ...
  public static class Header {
    ...
    public void init(GIFInputStream in) throws IOException {
    ...
    public void write(GIFOutputStream out) throws IOException {
      out.write(SIGNATURE);
      out.write(version);
    }
  ...
  public static class ScreenDescriptor {
    public static final int MSK_colorTableFlag  = 0x80;
    public static final int SHL_colorTableFlag  = 7;

    public static final int MSK_colorResolution = 0x70;
    public static final int SHL_colorResolution = 4;

    public static final int MSK_sortFlag        = 0x08;
    public static final int SHL_sortFlag        = 3;

    public static final int MSK_colorTableSize  = 0x07;
    public static final int SHL_colorTableSize  = 0;
    ...
    public String toString() {
      return 
	"{haui.GIF.ScreenDescriptor" + 
	" width='" + width + "'" +
	" height='" + height + "'" +
	" colorResolution='" + colorResolution + "'" +
	" backgroundColorIndex='" + backgroundColorIndex + "'" +
	" pixelAspectReatio='" + pixelAspectReatio + "'" +
	" sort='" + sortFlag + "'" +
	(colorTableFlag ? 
    ...
    public void init(GIFInputStream in) throws IOException {
      ...
      in.readBits();
      colorTableFlag  = in.getBoolean(MSK_colorTableFlag,  SHL_colorTableFlag);
      colorResolution = in.getInt(    MSK_colorResolution, SHL_colorResolution);
    ...
    public void write(GIFOutputStream out) throws IOException {
      ...
      out.clearBits();
      out.setBoolean(colorTableFlag, MSK_colorTableFlag,  SHL_colorTableFlag);
      out.setInt(colorResolution,    MSK_colorResolution, SHL_colorResolution);
  ...
  public static class ImageDescriptor {
    public static final int SEPARATOR = 0x2C;

    public static final int MSK_colorTableFlag = 0x80;
    public static final int SHL_colorTableFlag = 7;

    public static final int MSK_interlacedFlag = 0x40;
    public static final int SHL_interlacedFlag = 6;

    public static final int MSK_sortFlag = 0x20;
    public static final int SHL_sortFlag = 5;

    public static final int MSK_reserved = 0x18;
    public static final int SHL_reserved = 3;
    ...
    public String toString() {
      return 
	"{haui.GIF.ImageDescriptor" + 
	" left='" + leftPosition + "'" +
	" top='" + topPosition + "'" +
	" width='" + width + "'" +
	" height='" + height + "'" +
	" interlaced='" + interlacedFlag + "'" +
	" sort='" + sortFlag + "'" +
	(colorTableFlag ? 
	  " colorTableSize='" + colorTableSize + "'" 
	  : ""
    ...
    public void init(GIFInputStream in) throws IOException {
      ...
      in.readBits();
      colorTableFlag  = in.getBoolean(MSK_colorTableFlag,  SHL_colorTableFlag);
      interlacedFlag  = in.getBoolean(MSK_interlacedFlag,  SHL_interlacedFlag);
      sortFlag        = in.getBoolean(MSK_sortFlag,        SHL_sortFlag);
    ...
    public void write(GIFOutputStream out) throws IOException {
      ...
      out.clearBits();
      out.setBoolean(colorTableFlag, MSK_colorTableFlag,  SHL_colorTableFlag);
      out.setBoolean(interlacedFlag, MSK_interlacedFlag,  SHL_interlacedFlag);
      out.setBoolean(sortFlag,       MSK_sortFlag,        SHL_sortFlag);
  ...
  public static class ColorTable {
    ...
    public ColorTable init(GIFInputStream in, int sizeDescr) throws IOException {
  ...
  public static class Data {
    ...
    public String attrToString() {
      ...
      while (all != null) {
	cnt++;
	if (all.data != null) size += all.data.length;
  ...
  public static class Extension extends Data {
    public static final int SEPARATOR = 0x21;
    ...
    public static Extension read(GIFInputStream in) throws IOException {
      Extension result;

      int label = in.readByte();
      switch (label) {
      case ControlExtension.LABEL: 
    ...
    public void init(GIFInputStream in, int label) throws IOException {
  ...
  public static class ControlExtension extends Extension {
    public static final int SIZE  = 4;
    public static final int LABEL = 0xF9;

    public static final int DISPOSAL_NONE       = 0;
    public static final int DISPOSAL_NO         = 1;
    public static final int DISPOSAL_BACKGROUND = 2;
    public static final int DISPOSAL_PREVIOUS   = 3;

    public static final boolean USERINPUT_NO  = false;
    public static final boolean USERINPUT_YES = true;

    public static final boolean TRANSPARENCY_NO  = false;
    public static final boolean TRANSPARENCY_YES = true;
    ...
    public static final int MSK_reserved = 0xE0;
    public static final int SHL_reserved = 5;

    public static final int MSK_disposalMethod = 0x1C;
    public static final int SHL_disposalMethod = 2;

    public static final int MSK_userInputFlag = 0x02;
    public static final int SHL_userInputFlag = 1;

    public static final int MSK_transparentColorFlag = 0x01;
    public static final int SHL_transparentColorFlag = 0;
    ...
    public void init(GIFInputStream in, int label) throws IOException {
      ...
      transparentColorFlag = in.getBoolean(MSK_transparentColorFlag, SHL_transparentColorFlag);
    ...
    public void write(GIFOutputStream out) throws IOException {
      ...
      out.setBoolean(transparentColorFlag, MSK_transparentColorFlag, SHL_transparentColorFlag);
      out.writeBits();
  ...
  public static class CommentExtension extends Extension {
    public static final int LABEL = 0xFE;
  ...
  public static class TextExtension extends Extension {
  ...
  public static class ApplicationExtension extends Extension {
  ...
  */
  public static class NetscapeExtension extends ApplicationExtension {
    public static final byte[] ID = "NETSCAPE2.0".getBytes();
  ...
  public final static class Trailer {
    public static final int SEPARATOR = 0x3B;
    ...
    public static void write(GIFOutputStream out) throws IOException {
      out.write(Trailer.SEPARATOR);
    }
  }
  ...
  public static void parse(GIFInputStream in, ParseCallback callback) throws IOException {
    {
	...
	throw new StreamCorruptedException("unknown separator: " + separator);
      }
    }
  }

  public static Data readData(GIFInputStream in) throws IOException {
  ...
  public static void writeData(GIFOutputStream out, Data data) throws IOException {
    while (data != null) {
      data.write(out);
      data = data.next;
    }
  ...
  public static class Creator implements ParseCallback {
  ...
  public static class Filter implements Runnable, ParseCallback {
