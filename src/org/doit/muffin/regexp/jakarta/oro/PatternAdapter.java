...
public class PatternAdapter implements Pattern
{
    ...
    public PatternAdapter(String pattern, boolean ignoreCase)
    {
        throw new RuntimeException(
            "org.doit.muffin.regexp.jakarta.oro.PatternAdapter.getMatch"
    ...
    {
        throw new RuntimeException(
            "org.doit.muffin.regexp.jakarta.oro.PatternAdapter.matches"
                + " not yet implemented. Args were input <"
                + input
                + ">");
    }
    ...
    public static String fPattern = "what now";
    // this would need to be: org.apache.oro.text.regex.Pattern
