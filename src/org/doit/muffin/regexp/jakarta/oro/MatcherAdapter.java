...
public class MatcherAdapter implements Matcher
{
    ...
    public MatcherAdapter(Object matcher)
    {
        throw new RuntimeException(
            "org.doit.muffin.regexp.jakarta.oro.MatcherAdapter ctor"
    ...
    {
        throw new RuntimeException(
            "org.doit.muffin.regexp.jakarta.oro.MatcherAdapter.getStartIndex"
                + " not yet implemented. Args were sub <"
                + sub
                + ">");
    }
    ...
    {
        throw new RuntimeException(
            "org.doit.muffin.regexp.jakarta.oro.MatcherAdapter.getEndIndex"
                + " not yet implemented. Args were sub <"
                + sub
                + ">");
    }
    ...
    {
        throw new RuntimeException(
            "org.doit.muffin.regexp.jakarta.oro.MatcherAdapter.substituteInto"
                + " not yet implemented. Args were sub <"
                + input
                + ">");
    }
