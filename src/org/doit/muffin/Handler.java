/* $Id: Handler.java,v 1.2 1998/08/13 06:01:14 boyns Exp $ */
...
class Handler extends Thread
{
     ...
     */
    void copy (InputStream in, OutputStream out, int length, boolean monitored) throws java.io.IOException
    {
	if (length == 0)
	{
	    return;
     ...
     * @param monitored Update the Monitor
     */
    void flushCopy (InputStream in, OutputStream out, int length, boolean monitored) throws java.io.IOException
    {
	if (length == 0)
	{
	    return;
