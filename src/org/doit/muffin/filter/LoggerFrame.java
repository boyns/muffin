/* $Id: LoggerFrame.java,v 1.2 1998/08/13 06:02:29 boyns Exp $ */
...
public class LoggerFrame extends MuffinFrame implements ActionListener, WindowListener
{
    Prefs prefs;
    Logger parent;
    Checkbox eatReply, eatRequest;
    
    public LoggerFrame (Prefs prefs, Logger parent)
    {
	super ("Muffin: Logger");
