...
public class ImageKillFrame extends AbstractFrame {
	...
	private Panel makeConfigPanel(){
		...
		t_minheight.setText(
			Integer.toString(getFactory().getPrefsInteger(ImageKill.MINHEIGHT_PREF)));
		t_minwidth.setText(
			Integer.toString(getFactory().getPrefsInteger(ImageKill.MINWIDTH_PREF)));
		t_ratio.setText(Integer.toString(getFactory().getPrefsInteger(ImageKill.RATIO_PREF)));
		...
		t_replaceURL.setText(getFactory().getPrefsString(ImageKill.REPLACEURL_PREF));
		cb_keepmaps.setState(getFactory().getPrefsBoolean(ImageKill.KEEPMAPS_PREF));
		cb_replace.setState(getFactory().getPrefsBoolean(ImageKill.REPLACE_PREF));
	...
	protected void doApply() {
		...
		getFactory().putPrefsBoolean(ImageKill.KEEPMAPS_PREF, cb_keepmaps.getState());
		getFactory().putPrefsString(ImageKill.EXCLUDE_PREF, t_exclude.getText());
		getFactory().putPrefsString(ImageKill.RMSIZES_PREF, t_rmSizes.getText());
		getFactory().putPrefsString(ImageKill.REPLACEURL_PREF, t_replaceURL.getText());
		getFactory().putPrefsBoolean(ImageKill.REPLACE_PREF, cb_replace.getState());
		fFactory.setExclude();
